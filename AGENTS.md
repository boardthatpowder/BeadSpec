...
This project is indexed by GitNexus as **BeadSpec** (5410 symbols, 8038 relationships, 269 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
