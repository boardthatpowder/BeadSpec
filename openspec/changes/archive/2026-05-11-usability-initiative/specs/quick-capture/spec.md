...
- **THEN** BeadSpec logs a warning at startup and disables its own registration; the shortcut settings modal shows "Shortcut unavailable — change to a different binding"
