...
export default function QuickCaptureApp() {
  ...
  return (
    <div
      ref={containerRef}
      className="flex flex-col gap-3 p-4 bg-neutral-900 border border-neutral-700 rounded-xl shadow-2xl h-full"
      onKeyDown={handleKeyDown}
    >
      {/* Header */}
      <div className="flex items-center justify-between">
        <span className="text-neutral-300 text-sm font-medium">Quick Capture</span>
        <button
          onClick={hide}
      ...
      <div className="flex flex-col gap-1">
        <input
          ...
          className={[
            'w-full bg-neutral-800 border rounded-lg px-3 py-2 text-neutral-100 text-sm',
      ...
      <div className="flex items-center justify-between mt-auto">
        <span className="text-neutral-600 text-xs">Esc to cancel</span>
        <button
